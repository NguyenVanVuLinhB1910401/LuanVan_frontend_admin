...
const XuatKho = () => {
  ...
  const handleFormSubmit = (values, onSubmitProps) => {
    ...
    for(let i=0;i<dsSanPham.length;i++){
      ...
      if(dsSanPham[i].idSP === values.idSP &&  dsSanPham[i].idCN === values.idCN) {
      ...
      <Box m="20px 5px">
        ...
        <Box m="10px 0px">
          ...
          <Box>
            ...
            >
              <>
                <Typography fontWeight="bold" sx={{ gridColumn: 'span 9', textAlign: 'end' }}>
                  Tổng tiền:
                </Typography>
                <Typography  fontWeight="bold" sx={{ gridColumn: 'span 2', textAlign: 'end' }}>
