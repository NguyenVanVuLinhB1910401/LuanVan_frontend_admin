...
const PhieuXuat = () => {
    ...
    const columns = [
        ...
        { field: 'total', headerName: "Tổng tiền", flex: 1.5, valueGetter: (params) => parseInt(params.row.total).toLocaleString('it-IT', {
          style: 'currency',
          currency: 'VND',
        })},
        { field: 'dateTime', headerName: "Ngày nhập", flex: 1.5},
        {
          field: 'action',
